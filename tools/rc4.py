"""
RC4 uses Focal Loss to replace the SoftmaxWithLoss
COCO 2014 train + coco 2014 val + Vatic[A1Highwayday, B2HighwayNight,  airports, airports2] on Training
...
def prepare_data():
    ...
    cfg_path="pva-faster-rcnn/models/pvanet/lite/train.yml"
...
if __name__ == '__main__':
    ...
    solver = "models/pvanet/lite/coco_solver_focal.prototxt"
    train_pt = "models/pvanet/lite/coco_train_focal.prototxt"
